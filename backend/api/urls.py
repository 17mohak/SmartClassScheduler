...
from .views import (
    ...
    detect_conflicts, approve_leave, decline_leave
)
...
urlpatterns = [
    ...
    path('leave-applications/<int:pk>/approve/', approve_leave, name='approve-leave'),
    path('leave-applications/<int:pk>/decline/', decline_leave, name='decline-leave'),
